...
package com.dynatrace.diagnostics.plugin.HAProxyPlugin;
...
public class HAPMonitor implements Monitor {

	private static final Logger log = Logger.getLogger(HAPMonitor.class.getName());
	...
	public Status setup(MonitorEnvironment env) throws Exception {
		...
		URL url = new URL("http", env.getHost().getAddress(), (int)(long)env.getConfigLong("port"), "/;csv");

		URLConnection uc = url.openConnection();
		//if (env.getConfigBoolean("auth")) {
